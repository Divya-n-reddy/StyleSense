...
const getRecommendations = async (
  ...
  ${
    base64Image
      ? "Base your style analysis on the item in the attached image, suggesting complementary pieces to complete the look."
      : "Curate a capsule collection for this request."
  }
...
// --- IMAGE GENERATION ---
// Uses Pollinations instead of Gemini image generation.
// This avoids the Gemini image quota error.
const visualizeLook = async (name, description) => {
  try {
    ...
    const imageUrl =
      `https://image.pollinations.ai/prompt/${encodeURIComponent(prompt)}?model=flux&width=768&height=1024&nologo=true`;
...
const Button = ({
  ...
  const styles = {
    ...
    outline:
      "bg-transparent text-zinc-400 border border-zinc-200 hover:border-black hover:text-black",
  };
  ...
  return html`
    ...
    >
      ...
      ${
        loading &&
        html`
          <div className="w-4 h-4 border-2 border-current border-t-transparent animate-spin rounded-full mr-3"></div>
        `
      }
    ...
    <div className="bg-white rounded-[2.5rem] overflow-hidden border border-zinc-100 shadow-sm hover:shadow-xl transition-shadow duration-500 animate-fade-in group">
            ...
            : html`
                <div className="p-10 text-center space-y-4">
                  ...
                  <${Button}
                    ...
                    onClick=${handleVis}
                    loading=${loading}
                    className="py-2 text-[8px] shadow-sm"
                  >
                    Generate Visual
                  </${Button}>
      ...
      <div className="p-10 space-y-5">
          ...
          >
            ...
            >
              ...
              <path
                ...
                strokeWidth="1.5"
                d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 000-6.364z"
              />
        ...
        <div className="pt-6 border-t border-zinc-50">
          ...
          <span className="text-[9px] font-black uppercase tracking-widest text-amber-700 block mb-2">
            Styling Note
          </span>

          <p className="text-[12px] text-zinc-400 italic font-serif leading-snug">
            ${outfit.stylingTip}
          </p>
    ...
    <p className="text-zinc-500 max-w-md">
      ...
      ${
        message === 'API_KEY_MISSING'
          ...
          ? "We couldn't detect your Gemini API key. Please ensure you set the environment variable before running the server."
  ...
  const [saved, setSaved] =
    useState(() => {
      ...
      try {
        ...
        return JSON.parse(
          localStorage.getItem('saved_styles') || '[]'
        );
    ...
    <div className="min-h-screen luxury-gradient pb-40">
      ...
      <header className="sticky top-0 z-50 glass-panel border-b border-black/5 py-8 px-12 flex justify-between items-center">
        ...
        >
          ...
          <div className="w-12 h-12 bg-black rounded-2xl flex items-center justify-center text-white font-serif font-bold text-2xl shadow-xl transition-transform group-hover:scale-110">
            S
          </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-32 items-center">
                      ...
                      <div className="space-y-12">
                        ...
                        <div className="space-y-4">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-[0.5em] text-amber-700">
                            Experience Excellence
                          </span>

                          <h2 className="text-8xl font-serif font-bold leading-[0.95] tracking-tighter">
                        ...
                        <div className="bg-white/60 backdrop-blur-3xl border border-white p-14 rounded-[4rem] shadow-2xl space-y-12 relative overflow-hidden">
                          ...
                          <div className="absolute top-0 right-0 w-32 h-32 bg-amber-100/30 blur-3xl rounded-full -mr-16 -mt-16">
                          </div>
                              ...
                              f =>
                                html`
                                  ...
                                  >
                                    ...
                                    <select
                                      className="w-full bg-transparent border-b border-zinc-200 py-2 text-xs font-bold focus:outline-none focus:border-black transition-colors"
                                      value=${params[f]}
                                      onChange=${e =>
                                        setParams(
                                          p => ({
                      ...
                      <div className="relative group">
                        ...
                        <div className="absolute inset-0 bg-black/5 rounded-[4.5rem] transform translate-x-6 translate-y-6 -z-10 transition-transform group-hover:translate-x-4 group-hover:translate-y-4">
                        </div>


                        <div
                          className="aspect-[4/5] bg-white rounded-[4.5rem] border-[16px] border-white shadow-2xl overflow-hidden relative cursor-pointer"
                          onClick=${() =>
                            !image &&
                            document
                              .getElementById(
                            ...
                            image
                              ? html`
                                ...
                                <div className="relative h-full">
                                  ...
                                  <button
                                    ...
                                    className="absolute top-6 right-6 bg-black/50 text-white p-3 rounded-full backdrop-blur-md hover:bg-black transition-colors"
                                  >
                              ...
                              : html`
                                ...
                                <div className="flex flex-col items-center justify-center h-full space-y-8 text-zinc-300">
                                  ...
                                  <div className="w-20 h-20 border-2 border-dashed border-zinc-200 rounded-full flex items-center justify-center text-4xl">
                                    +
                                  </div>
                    ...
                    <div className="space-y-20 animate-fade-in">
                      ...
                      <div className="border-b border-zinc-100 pb-16 relative">
                        ...
                        <${Button}
                          ...
                          className="mb-12 border-none px-0 !text-zinc-400 hover:!text-black"
                        >
                          ← Create New Look
                        </${Button}>


                        <h2 className="text-7xl font-serif font-bold italic tracking-tight">
                          The Styled Edit
                        </h2>


                        <p className="text-zinc-400 text-lg max-w-2xl mt-8 leading-relaxed font-light font-serif">
                          ${result.vibeSummary}
                        </p>
          ...
          html`
            ...
            <div className="space-y-24 animate-fade-in">
              ...
              <div className="text-center space-y-6">
                ...
                <h2 className="text-7xl font-serif font-bold italic">
                  Your Collection
                </h2>

                <p className="text-zinc-400 uppercase text-[9px] tracking-[0.5em] font-black">
                  Private Selection
                </p>
                ...
                saved.length > 0
                  ...
                  : html`
                    ...
                    <div className="text-center py-40 border-2 border-dashed border-zinc-100 rounded-[4rem]">
                      ...
                      <p className="text-zinc-300 font-serif italic text-2xl">
                        Awaiting your curation.
                      </p>
      ...
      <footer className="mt-40 border-t border-zinc-100 pt-20 pb-10 text-center px-10">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-300">
          StyleSense AI Luxury Styling Service
        </p>

        <p className="text-[10px] text-zinc-400 mt-4 font-serif italic">
          Powered by Gemini 3.0 & 2.5 Intelligence
        </p>
